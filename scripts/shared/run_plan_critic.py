...
def build_prompt(root: Path, backend: str, handoff: dict[str, Any]) -> str:
    ...
    return (
        ...
        "Use required_questions only for issues that must be answered before the plan can be trusted.\n"
        "Prefer questions the planner can resolve by choosing a defensible recommended default.\n"
        "Reserve irreducible user-preference or product-direction choices for the smallest possible set of required_questions.\n"
