---
name: plan-critic
description: "Critically review an approved plan from a fresh isolated session before Beads creation. Use when Claude is acting as the adversarial reviewer in a planner debate flow."
---
